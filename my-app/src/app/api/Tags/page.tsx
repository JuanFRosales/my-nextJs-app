import { requireAuth } from "@/app/lib/authActions";
import { fetchAllTags, postTag } from "@/app/models/tagModel";
import { MediaItemTag } from "@/app/types/DBTypes";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const postResult = await postTag({ tag_name: tagData.tag_name, media_id: tagData.media_id });
